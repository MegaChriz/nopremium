...
class NodeEditTest extends NopremiumBrowserTestBase {
  ...
  public function testNodeFormWithoutOverridePremiumPermission() {
    // Create an user who may create/edit articles, but may *not* set premium.
  ...
  public function testNodeFormWithOverridePremiumAnyContentTypePermission() {
    // Create an user who may create/edit articles and set premium for all
    // content types.
    $editor = $this->drupalCreateUser([
      'create article content',
      'edit any article content',
  ...
  public function testNodeFormWithOverridePremiumArticlePermission() {
    ...
    // Create an user who may create/edit articles and foo nodes, but may only
    ...
    // types. Go to node create page for the foo content type and assert that
    // there's no premium field there.
