 ...
 * Provides a permission to override premium option for each content type. It
   allows users without the administer nodes permission to change the Premium
   content option on node editing. This completes what provides the essential
   Override Node Options module for core publishing options.
